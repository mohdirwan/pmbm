...
// Fetch sliders
$stmt = $pdo->query("SELECT * FROM app_sliders ORDER BY sort_order ASC, id ASC");
...
<head>
    <meta charset="UTF-8">
    <title>Manajemen Slider - Admin PMBM</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-primary fw-bold">Manajemen Slider Beranda</h2>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSlider"
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                                <div class="position-relative">
                                    <img src="<?= BASE_URL . $slider['image_path'] ?>" class="slider-img" alt="Slider Image">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title fw-bold text-truncate"
                                        ...
                                        <?= htmlspecialchars($slider['title'] ?: 'Tanpa Judul') ?>
                                    </h5>
                                    <p class="card-text text-muted small text-truncate">
                                        <?= htmlspecialchars($slider['description'] ?: 'Tidak ada deskripsi') ?>
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-outline-primary"
                                                onclick='openModal("edit", <?= json_encode($slider) ?>)'>
    ...
    <div class="modal fade" id="modalSlider" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="process.php" method="POST" enctype="multipart/form-data" id="formSlider">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="inputDescription" rows="2"
                                placeholder="Keterangan singkat slider..."></textarea>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        function openModal(mode, data = null) {
            ...
            if (mode === 'edit' && data) {
                ...
                modalTitle.innerText = 'Tambah Slider Baru';
                inputAction.value = 'add';
                btnSave.innerText = 'Simpan';
            }

            var myModal = new bootstrap.Modal(document.getElementById('modalSlider'));
            myModal.show();
        }
