        ...
        <div class="login-box">
            ...
            <div class="login-form">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-primary w-100 mb-3 rounded-pill shadow-sm"
                        style="background-color: var(--primary-color); border-color: var(--primary-color);">LOGIN</button>
