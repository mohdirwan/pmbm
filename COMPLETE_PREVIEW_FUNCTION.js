// Complete Preview Data Function
// Copy this function to register.php, replace existing showPreviewData()
...
function showPreviewData() {
    ...
    html += `
        <div class="card border-0 shadow-sm rounded-4 mb-3">
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    <div class="col-12"><h6 class="fw-bold text-primary">Data Ayah</h6></div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12"><hr><h6 class="fw-bold text-primary">Data Ibu</h6></div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12"><hr><h6 class="fw-bold text-primary">Data Wali (jika ada)</h6></div>
                    <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fw-bold">${formData.get('nilai_sem_iv_1') || '-'}</td>
                            </tr>
                            <tr>
                                <td>Semester IV (Empat) Genap (2)</td>
                                <td class="fw-bold">${formData.get('nilai_sem_iv_2') || '-'}</td>
                            </tr>
                            <tr>
                                <td>Semester V (Lima) Ganjil (1)</td>
                                <td class="fw-bold">${formData.get('nilai_sem_v_1') || '-'}</td>
                            </tr>
                            <tr>
                                <td>Semester V (Lima) Genap (2)</td>
                                <td class="fw-bold">${formData.get('nilai_sem_v_2') || '-'}</td>
                            </tr>
                            <tr>
                                <td>Semester VI (Enam) Ganjil (1)</td>
                                <td class="fw-bold">${formData.get('nilai_sem_vi_1') || '-'}</td>
                            </tr>
                        </tbody>
                        <tfoot class="table-light">
                            <tr>
                                <th>Jumlah Nilai:</th>
                                <th class="fw-bold">${document.getElementById('jumlah_nilai_display')?.value || '-'}</th>
                            </tr>
                            <tr>
                                <th>Rata-Rata Nilai:</th>
                                <th class="fw-bold text-primary">${document.getElementById('rata_rata_display')?.value || '-'}</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-3">
            ...
            <div class="card-body p-4">
                <div class="row g-3" id="filesPreviewContainer">
                    <!-- Will be filled by file preview logic -->
                </div>
            </div>
        </div>
    `;
